...
function Pricing(props) {
    ...
    letterSpacing: -0.66, lineHeight: '38px', textAlign: 'center', marginBottom: 70, maxWidth: 800}}>We offer a very simple price structure. <br></br>Your website + everything you need to run it for £29/month.</p>
              <PriceTable/>
              </Container>
