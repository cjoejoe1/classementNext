  ...
  return (
    ...
    <Layout type='special' target="pro">
        ...
        <Container style={{maxWidth: 1140}}>
          ...
          <h1 id='compareh1'>Meilleur Digital Learning de 2023</h1>
          <p id='compareh2' style={{marginLeft: 5, marginBottom: 25, fontWeight: 300, fontSize: 24, marginTop: -10}}>Comparatifs et guides pratiques pour trouver votre solution digital learning</p>
