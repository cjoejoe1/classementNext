...
var y = d.getFullYear();
 ...
 <Breadcrumbs link="/pro/"  text='Logiciel SEO' cat="Pro"/>
 <Container fluid style={{background: 'rgb(243,243,243)', paddingTop: 100, paddingBottom: 50}}>
   
   <Container style={{maxWidth: 1140}}>

          <h1 id='compareh1'>Logiciel SEO <span id='noMobile'>(Classement 2025)</span></h1>
       ...
       <p style={{fontSize: 16}}><span id='oneTwo'>1</span> Utilisez le menu de notre <span style={{fontWeight: 700}}>comparateur de logiciels SEO</span> pour déterminer vos priorités.</p>
       ...
       <p style={{fontSize: 16}}><span id='oneTwo'>3</span> Sélectionnez le <span style={{fontWeight: 700}}>meilleur logiciel SEO</span>, celui qui correspond le plus a vos besoins.</p>
       </div>
       <Disclosure/>
