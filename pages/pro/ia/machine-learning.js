...
const Ia = () => {
  ...
  return (
    <Layout >
           <Seo
        title="Machine Learning Intelligence Articielle"
        description="Liste des solutions d'intelligence artificielle pour le machine learning"
      />
          ...
          <Breadcrumbs link="/intelligence-artificielle/" text='IA Machine Learning' cat="Intelligence Artificielle"/>
          <h1 id='compareh1'>Machine Learning (Intelligence Articielle)</h1>
          <p id='compareh2' style={{marginLeft: 5, marginBottom: 25, fontWeight: 300, fontSize: 24, marginTop: -10}}>Liste des solutions d'intelligence artificielle pour le machine learning (mise à jour {n} {y})</p>
...
<tbody>
          ...
          {data.filter(company => company.category === 'ML Platforms').map(renderCompany)}
          </tbody>
</Table>
