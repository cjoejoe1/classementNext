...
const Ia = () => {
  ...
  return (
    <Layout >
           <Seo
        title="Audio Intelligence Articielle"
        description="Liste des solutions d'intelligence artificielle pour audio"
      />
          ...
          <Breadcrumbs link="/intelligence-artificielle/" text='IA Audio' cat="Intelligence Artificielle"/>
          <h1 id='compareh1'>Audio (Intelligence Articielle)</h1>
          <p id='compareh2' style={{marginLeft: 5, marginBottom: 25, fontWeight: 300, fontSize: 24, marginTop: -10}}>Liste des solutions d'intelligence artificielle pour l'audio (mise à jour {n} {y})</p>
...
<tbody>
          ...
          {data.filter(company => company.category === 'Audio').map(renderCompany)}
          </tbody>
</Table>
