...
const Ia = () => {
  ...
  return (
    <Layout >
           <Seo
        title="Image Intelligence Articielle"
        description="Liste des solutions d'intelligence artificielle pour l'image"
      />
          ...
          <Breadcrumbs link="/intelligence-artificielle/" text='IA Image' cat="Intelligence Artificielle"/>
          <h1 id='compareh1'>Image (Intelligence Articielle)</h1>
          <p id='compareh2' style={{marginLeft: 5, marginBottom: 25, fontWeight: 300, fontSize: 24, marginTop: -10}}>Liste des solutions d'intelligence artificielle pour l'image' (mise à jour {n} {y})</p>
