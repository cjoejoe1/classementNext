...
const Ia = () => {
  ...
  return (
    <Layout >
           <Seo
        title="Gaming Intelligence Articielle"
        description="Liste des solutions d'intelligence artificielle pour le gaming"
      />
          ...
          <Breadcrumbs link="/intelligence-artificielle/" text='IA Gaming' cat="Intelligence Artificielle"/>
          <h1 id='compareh1'>Gaming (Intelligence Articielle)</h1>
          <p id='compareh2' style={{marginLeft: 5, marginBottom: 25, fontWeight: 300, fontSize: 24, marginTop: -10}}>Liste des solutions d'intelligence artificielle pour le gaming (mise à jour {n} {y})</p>
...
<tbody>
          ...
          {data.filter(company => company.category === 'Gaming').map(renderCompany)}
          </tbody>
</Table>
