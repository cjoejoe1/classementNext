...
const Ia = () => {
  ...
  return (
    <Layout >
           <Seo
        title="Search Intelligence Articielle"
        description="Liste des solutions d'intelligence artificielle pour le search"
      />
          ...
          <Breadcrumbs link="/intelligence-artificielle/" text='IA Search' cat="Intelligence Artificielle"/>
          <h1 id='compareh1'>Search (Intelligence Articielle)</h1>
          <p id='compareh2' style={{marginLeft: 5, marginBottom: 25, fontWeight: 300, fontSize: 24, marginTop: -10}}>Liste des solutions d'intelligence artificielle pour le search (mise à jour {n} {y})</p>
...
<tbody>
          ...
          {data.filter(company => company.category === 'Search').map(renderCompany)}
          </tbody>
</Table>
