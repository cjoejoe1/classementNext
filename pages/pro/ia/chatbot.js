...
const Ia = () => {
  ...
  return (
    <Layout >
           <Seo
        title="Chatbot Intelligence Articielle"
        description="Liste des solutions d'intelligence artificielle chatbot"
      />
          ...
          <Breadcrumbs link="/intelligence-artificielle/" text='IA Chatbot' cat="Intelligence Artificielle"/>
          <h1 id='compareh1'>Chatbot Intelligence Articielle</h1>
          <p id='compareh2' style={{marginLeft: 5, marginBottom: 25, fontWeight: 300, fontSize: 24, marginTop: -10}}>Liste des solutions d'intelligence artificielle chatbot (mise à jour {n} {y})</p>
...
<tbody>
          ...
          {data.filter(company => company.category === 'Chatbots').map(renderCompany)}
          </tbody>
</Table>
