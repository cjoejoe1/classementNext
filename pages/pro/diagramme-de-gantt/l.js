...
function Comparateur() {
  ...
  return (
    ...
    <Layout type='landing-compare'>
        ...
        <Seo title="Diagramme de Gantt | Createur.com"
         description="Créer un diagramme de Gantt avec createur.com"/>
      <Container fluid style={{background: 'rgb(243,243,243)', paddingTop: 20, paddingBottom: 50}}>
       
        <Container style={{maxWidth: 1140}}>
          {/* <Breadcrumbs text='Diagramme de Gantt' cat="Comparateurs"/> */}
          <div style={{marginTop : -20, marginBottom:40}} id='max992'>
              <Disclosure/>
            </div>
          <h1 id='compareh1'>Meilleur Diagramme de Gantt de 2023</h1>
          ...
          <div id='undeuxtrois' style={{marginLeft: 10, marginTop: 0, marginBottom: 30}}>
            <p style={{fontSize: 16}}><span id='oneTwo'>1</span> Utilisez le menu de notre <span style={{fontWeight: 700}}>comparateur diagramme de gantt</span> pour déterminer vos priorités.</p>
            ...
            <p style={{fontSize: 16}}><span id='oneTwo'>3</span> Sélectionnez le <span style={{fontWeight: 700}}>meilleur diagramme de gantt</span>, celui qui correspond le plus a vos besoins.</p>
          </div>
