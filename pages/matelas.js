...
const [values, setValues] = useState({
  ...
  return (
    <Layout url="matelas" category="matelas" type="category" page={p}>
      ...
      <Seo title="Meilleur matelas 2025 - comparatif et classement complet"
      ...
      <div style={{ marginTop: 50}}>
       <div id='homeBox'>
        <Row style={{}}>
          <Col sm={9}>
          <h1 className='h1compare' id='comparatif' style={{textAlign: 'left', color: 'black', marginTop: 5, paddingTop: 50}}>Recevez le classement {kw && kw || 'matelas'}<span id='min992'>*</span><span id='max992'> 2025</span></h1>
