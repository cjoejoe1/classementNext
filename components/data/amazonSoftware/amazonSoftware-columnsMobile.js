...
export const COLUMNS = [
  {
    ...
    Cell: e =>{
      ...
      //           <div style={{fontSize: 24, padding: 8}}><FontAwesomeIcon icon={faCheck} style={{marginTop: 0, marginBottom: -3, fontSize: 24, marginLeft: 5, color: '#0ea20e'}}/></div>
      //         </div>
      //       ) 
      //     } else{
      //       return (
...
//                 <Bs.Button id="comparateurButton" type="submit" className="btn-lg" style={{height: 40, backgroundColor: '#E5234F', padding: 7, borderColor: '#E5234F', width: 120, fontSize: 14, boxShadow: '0 0 8px 0 rgb(0 0 0 / 30%)'}}>Voir l'offre <FontAwesomeIcon icon={faAngleDoubleRight} style={{marginTop: 0, marginBottom: -3, fontSize: 24, marginLeft: 5}}/></Bs.Button>
//           </a>
//         </div>
//       )
//     },
