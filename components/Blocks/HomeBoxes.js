...
<Row style={{marginTop: 50, marginBottom: 0, maxWidth: 1268}} >
  <Col lg={6}>
  
<div style={{marginTop: 0}}>
      <Link href={`/createur-de-site/`} id='textOnHover'>
        <div style={{ minHeight: 165, borderRadius: 5, display: 'flex', paddingLeft: 40, paddingRight: 30, paddingTop: 25, paddingBottom : 16, justifyContent: 'space-between'}}  id='cardOnHoverMarket'>
