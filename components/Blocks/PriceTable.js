    ...
    <Col sm={6} style={{textAlign: 'center'}}>
        <div className="card mb-4 box-shadow">
          ...
          <div className="card-body d-flex flex-column">
            ...
            <Link href={'/start'}><Button id='buttonHover' className="btn-lg btn btn btn-primary" style={{fontWeight: 700, marginTop: 50, paddingTop: 6, height: 60, minWidth: 250}}>Start Now <FaArrowRight /></Button></Link>
          </div>
        </div>
     </Col>
    <Col sm={6} style={{textAlign: 'center'}}>
