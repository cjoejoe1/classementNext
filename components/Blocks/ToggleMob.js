...
const Toggle = ({checked, setChecked, radioValue, setRadioValue, target}) => {
  ...
  return (
    ...
    <Link href='/pro/'><Button variant="danger" style={{marginLeft: 10}}>Pro</Button></Link>
    </div>
    : 
    <div>
    <Link href='/'><Button variant="primary">Particulier</Button></Link>
    <Link href='/pro/'><Button variant="danger-outline" style={{marginLeft: 10}}>Pro</Button></Link>
    </div>
    }
    </>
  );
